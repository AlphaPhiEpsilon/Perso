...
$logDir = Split-Path $Tr# Désactiver les popups
[System.Windows.Forms.MessageBox]::Show = { return "OK" }
$ErrorActionPreference = "SilentlyContinue"

Add-Type -AssemblyName System.Windows.Forms
Add-Type -AssemblyName System.Drawing
$Host.UI.RawUI.WindowTitle = "DASHBOARD_PERSO"
# ==============================================
# DÉMARRAGE DE L'ENREGISTREMENT DE TOUTE LA SESSION
# ==============================================
$TranscriptLog = "C:\Users\Teri\Desktop\log\powershell_complet.log"
...
# Fonction pour journaliser TOUTES les erreurs PowerShell
...
for ($i = 0; $i -lt $btnActionses.Count; $i++) {
    $index = $i
    ...
    $btnActionses[$i].ContextMenuStrip = $menu
}
...
$form.ShowDialog()anscriptLog -Parent
if (!(Test-Path $logDir)) { New-Item -ItemType Directory -Path $logDir -Force }
Start-Transcript -Path $TranscriptLog -Append
